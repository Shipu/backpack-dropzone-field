...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_styles')
        ...
        <link rel="stylesheet" href="{{ asset('vendor/shipu/backpack-dropzone/dropzone.min.css') }}" />
    @endpush

    {{-- FIELD JS - will be loaded in the after_scripts section --}}
    @push('crud_fields_scripts')
        <!-- include dropzone js-->
        <script src="{{ asset('vendor/shipu/backpack-dropzone/dropzone.js') }}"></script>
        <script src="{{ asset('vendor/shipu/backpack-dropzone/Sortable.min.js') }}"></script>
    @endpush
        ...
        jQuery(document).ready(function() {
            ...
            var dOptions = {
                ...
                sending: function(file, xhr, formData) {
                    ...
                    @if (isset($field['collection']) && !empty($field['collection']))
                        formData.append('collection', "{{ $field['collection'] }}");
                    @endif
                    @if (isset($field['thumb_collection']) && !empty($field['thumb_collection']))
                        formData.append('thumb_collection', "{{ $field['thumb_collection'] }}");
                    @endif
                },
